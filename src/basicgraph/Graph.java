...
public abstract class Graph {
	...
	public static void main (String[] args) {
		...
		System.out.println("Degree sequence is");
		System.out.println(Arrays.toString(graphFromFile.degreeSequence().toArray()));
		
		System.out.println("Distance2 Neighbors are:");
		System.out.println(Arrays.toString(graphFromFile.getDistance2(0).toArray()));
